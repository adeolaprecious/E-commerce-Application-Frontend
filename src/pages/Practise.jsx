...
const Signup = () => {
    ...
    //         email: yup.string("Input your email here").required("Email is required").email("Invalid email format"),
  ...
  return (
    <StyledWrapper>
      <form className="form">
        ...
        <div className="flex">
          <label>
            <input required placeholder type="text" className="input" name="firstName" />
            <span>Firstname</span>
          </label>

          <label>
            <input required placeholder type ="text " className = "input " name="lastName" />
            <span>Lastname</span>
          </label>
        </div>  
        <label>
